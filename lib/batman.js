(function() {
  ...
  Batman.Association.hasOne = (function() {
    ...
    hasOne.prototype.getAccessor = function(self, model, label) {
      var existingInstance, id, loadOptions, loadedRecord, relatedModel, relatedModelName, relatedRecords;
      if (this.amSetting) {
        return;
      }
    ...
    hasOne.prototype.clearRelation = function(base) {
      var relatedModel;
      if (relatedModel = this.getRelatedModel()) {
        return relatedModel.get('loaded').indexedBy(this.foreignKey).get(base.id).forEach(__bind(function(relatedInstance) {
          relatedInstance.unset(this.foreignKey);
          return relatedInstance.unset(this.propertyName);
        }, this));
      }
    };
    return hasOne;
  ...
  Batman.Association.hasMany = (function() {
    ...
    hasMany.prototype.save = function(baseSaveError, base) {
      ...
      if (relatedModels = (_ref = base._batman.attributes) != null ? _ref[this.label] : void 0) {
        return relatedModels.forEach(__bind(function(model) {
          return model.set(this.foreignKey, base.id);
        }, this));
      }
    };
    ...
    hasMany.prototype.decodeObjectIntoModel = function(model, obj, data) {
      var id, idRegex, json, matchResult, record, relatedModel, relations, storageKey;
      if (json = data[this.label]) {

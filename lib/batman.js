  ...
  Batman.Model = (function() {
    ...
    Model.prototype.save = function(callback) {
      ...
      return this.validate(__bind(function(isValid, errors) {
        var associations, belongsTo, creating, hasMany, hasOne, k, modelSaved, _l, _len4, _ref5, _ref6;
        if (!isValid) {
          if (typeof callback === "function") {
            callback(errors);
          }
        ...
        if (associations = this.constructor.associations) {
          _ref5 = associations.getObject(), belongsTo = _ref5.belongsTo, hasOne = _ref5.hasOne, hasMany = _ref5.hasMany;
          _ref6 = [belongsTo, hasOne, hasMany];

(function() {
  ...
  Batman.Model = (function() {
    ...
    _ref = ['hasOne', 'belongsTo', 'hasMany'];
    _fn = function(k) {
      return Model[k] = function(label, model) {
        return new Batman.Association[k](this, label, model);
      };
    };
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      k = _ref[_i];
    ...
    Model.prototype.save = function(callback) {
      ...
      return this.validate(__bind(function(isValid, errors) {
        var associations, belongsTo, creating, hasMany, hasOne, k, modelSaved, _l, _len4, _ref5;
        if (!isValid) {
          if (typeof callback === "function") {
            callback(errors);
          }
          ...
          if (!mainErr) {
            ...
            if (hasOne != null) {
              hasOne.forEach(__bind(function(key) {
                var foreignKey, model, _ref6;
                if (model = (_ref6 = record._batman.attributes) != null ? _ref6[key] : void 0) {
            ...
            if (hasMany != null) {
              hasMany.forEach(__bind(function(key) {
                var hasManySet, _ref6;
                if (hasManySet = (_ref6 = record._batman.attributes) != null ? _ref6[key] : void 0) {
